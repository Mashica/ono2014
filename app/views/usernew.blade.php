...
@section('pagebody')
	<h3>Nuevo Ciclista</h3>

	<div>
		{{ Form::open( array('route' => 'u_create') ) }}
			...
			<div>{{ Form::text('lastname1') }}</div>

			<div>{{ Form::label('lastname2', 'Segundo apellido') }}</div>
			<div>{{ Form::text('lastname2') }}</div>
		    ...
		    <div>{{ Form::submit('Regístrate') }}</div>
